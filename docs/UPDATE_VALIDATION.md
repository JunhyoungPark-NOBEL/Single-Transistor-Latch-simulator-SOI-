...
> Historical update record. The current independent Biristor Studio release is documented in [RELEASE_CHECKS_KO.md](RELEASE_CHECKS_KO.md) and [STUDIO_QA.md](STUDIO_QA.md). The earlier HTTP-worker restriction described below was resolved; this release has passed actual local and authenticated cross-origin HTTP computation.
