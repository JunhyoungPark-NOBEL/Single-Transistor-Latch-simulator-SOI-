...
// Usage: node scripts/verify-artifact.mjs [--shots <dir>] [--port 5211] [--serve]   (--serve: only serve)
...
const TYPES = { ".js": "text/javascript", ".css": "text/css", ".json": "application/json", ".gz": "application/gzip", ".woff2": "font/woff2", ".svg": "image/svg+xml", ".html": "text/html" };
...
console.log(`[verify] serving ${path.relative(WEB, DIST)} at ${BASE}/ (no /api)`);
