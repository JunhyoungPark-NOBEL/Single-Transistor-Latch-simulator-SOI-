  ...
  sections: [
    {
      ...
      body: {
        ko: "p[0]–p[8]은 `refit_3.json`(= `data/tables/parameters.json`)에서, p[9], p[10]은 `gate_dynamic_calibration.json`에서 가져온다. 이름 뒤 괄호에는 그 파라미터를 쓰는 주제를, 코드 열에는 인덱스와 웹 JSON 키를 적었다.",
        en: "p[0]–p[8] come from `refit_3.json` (= `data/tables/parameters.json`), p[9] and p[10] from `gate_dynamic_calibration.json`. The topic that uses each parameter is given in brackets; the code column shows the index and the web JSON key.",
      },
      variables: [
        {
        ...
        },
        {
          ...
          name: { ko: "바디 SRH 전자 수명 (bjt-transport)", en: "Body SRH electron lifetime (bjt-transport)" },
        ...
        },
        {
          ...
          name: { ko: "소스 접합 SRH 수명 (bjt-transport)", en: "Source-junction SRH lifetime (bjt-transport)" },
        ...
        },
        {
          ...
          name: { ko: "접근 영역 slab 두께 (bjt-transport)", en: "Access-slab thickness (bjt-transport)" },
          value: "3.312684",
          unit: "nm",
        ...
        },
        {
          ...
          name: { ko: "접근 영역 억셉터 농도 (bjt-transport)", en: "Access acceptor density (bjt-transport)" },
          value: "1.000240 × 10¹⁷",
          unit: "cm⁻³",
        ...
        },
        {
          ...
          name: { ko: "접근 영역 길이 (bjt-transport)", en: "Access length (bjt-transport)" },
          value: "70.0",
          unit: "nm",
        ...
        },
        {
          ...
          name: { ko: "SRH 수명 비 (bjt-transport)", en: "SRH lifetime ratio (bjt-transport)" },
          value: "117.4247",
          unit: "–",
        ...
        },
        {
          ...
          name: {
            ko: "드레인 가장자리 상태의 평균 오프셋 (btbt-gidl, local-states)",
        ...
        },
        {
          ...
          name: {
            ko: "이미터 상태의 평균 오프셋 (bjt-transport, local-states)",
        ...
        },
        {
          ...
          value: "−2.0 reference / −1.8 illumination",
          unit: "V",
          code: "p[11] · vg",
        },
        {
    ...
    },
    {
      ...
      body: {
        ko: "모든 확장이 중립값(아래 기본값)이면 모델은 확장 없는 기본 모델(`gate_mean.py`)과 1e-12 V 이내로 같다(`VALIDATION.md`). UI에서 pA 단위로 입력한 값은 10⁻¹²를 곱해 A 단위로 넣는다.",
        en: "With every extension at its neutral value (defaults below), the model equals the base model without extensions (`gate_mean.py`) to within 1e-12 V (`VALIDATION.md`). Values entered in pA in the UI are multiplied by 10⁻¹² to give A.",
      },
      variables: [
        {
          symbol: String.raw`I_{\mathrm{PH}}`,
          name: { ko: "광생성 전류 (photo)", en: "Photogeneration current (photo)" },
          value: "0 (illumination preset: R·P)",
          unit: "A",
          code: "p[13] · light",
        },
        {
        ...
        },
        {
          ...
          name: { ko: "바디→채널 결합 (channel)", en: "Body-to-channel coupling (channel)" },
          value: "0 (illumination preset 0.2794239)",
          unit: "V/V",
          code: "p[15] · ext.gamma",
        },
        {
        ...
        {
          symbol: "I_p",
          name: { ko: "고 V_D 채널 시드, V_G = −1.8 V 기준 (channel)", en: "High-V_D channel seed at V_G = −1.8 V (channel)" },
        ...
        {
          symbol: "S",
          name: { ko: "시드 기울기 (channel)", en: "Seed slope (channel)" },
        ...
        },
        {
          ...
          name: { ko: "국소 애벌랜치 세기 (impact-ionization)", en: "Local avalanche strength (impact-ionization)" },
          value: "0",
          unit: "–",
          code: "p[21] · ext.aloc",
        },
        {
          ...
          name: { ko: "국소 경로 포화 전류 (impact-ionization)", en: "Local-path saturation (impact-ionization)" },
          value: "2 × 10⁻¹¹ (20 pA)",
          unit: "A",
        ...
        },
        {
          ...
          name: {
            ko: "국소 경로의 로그 요동 (impact-ionization, local-states)",
        ...
        },
        {
          ...
          name: {
            ko: "국소 경로의 캐리어 정의 0/1/2 (impact-ionization)",
        ...
        },
        {
          ...
          name: { ko: "국소 경로의 전계 의존성 (impact-ionization)", en: "Local-path field dependence (impact-ionization)" },
          value: "0",
          unit: "1/V",
      ...
      notes: [
        {
          ko: "p[24] = 2('채널을 뺀 가장자리 정의')는 코드에서 p[24] = 1(벌크)과 똑같이 동작한다. `bulk = p[24] > 0.5`가 먼저 참이 되어 `edge_only` 분기에 도달하지 않기 때문이다(`impact-ionization`).",
          en: "p[24] = 2 ('edge definition without the channel') behaves exactly like p[24] = 1 (bulk) in the code: `bulk = p[24] > 0.5` is already true, so the `edge_only` branch is never reached (`impact-ionization`).",
        },
        {
          ko: String.raw`p[17] > 0이면 코드가 p[18]로 나누므로 $S \ne 0$이어야 한다.`,
    ...
    },
    {
      ...
      variables: [
        {
          symbol: "N_A",
          name: { ko: "바디 도핑 (refit)", en: "Body doping (refit)" },
          value: "2.295773 × 10¹⁷",
          unit: "cm⁻³",
        ...
        },
        {
          ...
          name: { ko: "베이스 이동도 (bjt-transport)", en: "Base mobilities (bjt-transport)" },
          value: "450, 150",
          unit: "cm²/(V·s)",
          code: "DN, DP",
        },
        ...
        },
        {
          ...
          name: { ko: "GIDL 깊이 계산용 도핑, 활성 길이 (btbt-gidl)", en: "GIDL depth doping, active length (btbt-gidl)" },
          value: "7 × 10¹⁹ cm⁻³, 5 nm",
          code: "components() depth, volume",
        },
        {
          symbol: "5.6",
          name: { ko: "κ_F의 기준 V_DG ≈ (u + r) − V_G (접합 전압 합으로 본 드레인 − 게이트; 코드 주석은 V_GD로 적음) (impact-ionization)", en: "Reference V_DG for κ_F, ≈ (u + r) − V_G (drain − gate from the junction voltages; the code comment calls it V_GD) (impact-ionization)" },
          value: "5.6",
          unit: "V",
    ...
    {
      heading: { ko: "국소 상태의 진폭과 동역학 (기준 보정)", en: "Local-state amplitudes and kinetics (reference calibration)" },
      variables: [
        {
          symbol: String.raw`\sigma_{\varphi G}`,
          name: { ko: "드레인 가장자리 상태 SD (p[9]에 작용)", en: "Drain-edge state SD (acts on p[9])" },
          value: "0.1533904",
          unit: "V",
        ...
        },
        {
          ...
          name: { ko: "소스 가장자리(이미터) 상태 SD (p[10]에 작용)", en: "Source-edge (emitter) state SD (acts on p[10])" },
        ...
        },
        {
          ...
          name: { ko: "이미터 OU 상관 시간 (빠른 성분)", en: "Emitter OU correlation time (fast component)" },
          value: "1.620556",
          unit: "s",
        ...
        },
        {
          ...
          name: { ko: "드레인 가장자리 OU, 스윕 내 잔차", en: "Drain-edge OU, within-sweep residual" },
          value: "5.0",
          unit: "s",
        ...
        },
        {
          ...
          name: { ko: "LD 사건 감도", en: "LD event sensitivity" },
        ...
        },
        {
          ...
          name: { ko: "fold 감도, V_G = −2 V", en: "Fold sensitivity, V_G = −2 V" },
    ...
    {
      heading: { ko: "광조사 보정 (V_G = −1.8 V, 암조건)", en: "Illumination calibration (V_G = −1.8 V, dark)" },
      body: {
        ko: String.raw`목표: 400 사이클, 평균 3.8061 V, SD 173.2 mV, lag-1 0.199. 확인(계산값): 광조사 보정 프리셋의 −1.1 V 암조건 fold 3.4079 V가 측정 평균 3.408 V와 일치한다($\gamma$의 역할).`,
        en: String.raw`Target: 400 cycles, mean 3.8061 V, SD 173.2 mV, lag-1 0.199. Check (computed): the fold of the illumination-calibration preset at −1.1 V dark, 3.4079 V, matches the measured mean of 3.408 V (this is what $\gamma$ is for).`,
      },
      equations: [
        {
          id: "eq-par-c2c",
          label: { ko: "fold 모멘트 맞춤 (고정 상태)", en: "Fold-moment matching (frozen states)" },
          ...
          note: {
            ko: "fold 표는 $\\delta\\varphi \\in [-1.5, 2.0]$ V(0.05 V 간격, PCHIP)이고, 40점 Gauss–Hermite 적분을 쓰며, 래치 범위 밖의 노드는 버리고 가중치를 재정규화한 뒤 `fsolve`로 푼다. 1200 V/s 램프는 상태 동역학보다 훨씬 빠르므로, 고정 상태에서 $V_{\\mathrm{LU}} \\approx$ fold이다.",
            en: "Fold table over $\\delta\\varphi \\in [-1.5, 2.0]$ V (0.05 V steps, PCHIP), 40-node Gauss–Hermite quadrature, nodes outside the latch range dropped and the weights renormalized, solved with `fsolve`. The 1200 V/s ramp is much faster than the state kinetics, so with frozen states $V_{\\mathrm{LU}} \\approx$ fold.",
          },
      ...
      variables: [
        {
          ...
          name: { ko: "드레인 가장자리 상태 중심", en: "Drain-edge state center" },
          value: "+0.07443209",
          unit: "V",
        ...
        },
        {
          ...
          name: { ko: "드레인 가장자리 상태 SD (광조사 보정)", en: "Drain-edge state SD (illumination calibration)" },
          value: "0.2153646",
          unit: "V",
        ...
        {
          symbol: String.raw`\gamma`,
          name: { ko: "바디 결합 (−1.1 V 암조건 평균으로 설정)", en: "Body coupling (set by the −1.1 V dark mean)" },
          value: "0.2794239",
          unit: "V/V",
        ...
        {
          symbol: "R",
          name: { ko: "광 변환 응답도 (photo)", en: "Optical-conversion responsivity (photo)" },
          value: "0.75",
          unit: "pA/mW",
    ...
    },
    {
      ...
      notes: [
        {
          ko: "p[0..8]은 사이클 간 변동(C2C)이 큰 한 소자에 대한 조건부 fit이다(`MODEL_PARAMETERS.json` scope).",
          en: "p[0..8] is a conditional fit for a single device with large cycle-to-cycle (C2C) variation (`MODEL_PARAMETERS.json` scope).",
        },
      ],
    },
  ],
