...
export const BENCHES: Record<BenchId, BenchDef> = {
  ...
  pbit: {
    ...
    fields: [
      ...
      { key: "v_ref_V", sym: "V_{\\mathrm{ref}}", label: L("비교기 기준 전압", "Comparator V_ref"), help: L("자동: R_S × 1 µA. 비트 = [V(R_S) > V_ref], 펄스 평탄부 끝에서", "auto: R_S × 1 µA. bit = [V(R_S) > V_ref] at the end of the pulse flat top"), unit: "V", min: -8, max: 8, step: 0.01, auto: true },
      f.vg,
