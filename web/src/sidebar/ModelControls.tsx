...
const FIELDS: (FieldDef & { parameter: keyof SimpleModelBlock })[] = [
  ...
  { parameter: "gidl_volume_ref_cm3", sym: "V_{GIDL}", label: L("GIDL 생성 체적", "GIDL generation volume"), help: L("GIDL 정공이 생성되는 체적입니다. 기준 폭 200 nm에서의 값이며 폭에 비례해 환산합니다. 기본값 4.55×10⁵ nm³는 논문 참고 스크립트의 유효 체적(W·5 nm·4.55 nm×100)이고, 물리 체적 W·5 nm·4.55 nm는 4.55×10³ nm³입니다.", "Volume in which GIDL holes are generated, at the reference width 200 nm and scaled with W. The default 4.55×10⁵ nm³ is the paper script's effective volume (W·5 nm·4.55 nm×100); the bare physical volume W·5 nm·4.55 nm is 4.55×10³ nm³."), min: 0, max: 1e12, scale: 1e21, unit: "nm³" },
