...
export const BRAND_STRINGS = {
  ...
  // About chip (context strip, right end); the credit itself is the reduced "KAIST · NOBEL 연구실" everywhere
  "brand.credits.full": { ko: "정보", en: "About" },
  "brand.credits.aria": { ko: "STL Simulator 정보", en: "About STL Simulator" },
  ...
  "brand.about.lab": { ko: "만든 곳", en: "Made at" },
  "brand.about.lab.value": { ko: "KAIST · NOBEL 연구실", en: "KAIST · NOBEL Lab" },
