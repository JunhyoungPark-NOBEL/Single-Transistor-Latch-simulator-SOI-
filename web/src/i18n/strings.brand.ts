...
export const BRAND_STRINGS = {
  ...
  "axis.foldV": { ko: "fold 전압 V<sub>LU</sub>, V<sub>LD</sub> (V)", en: "Fold voltage V<sub>LU</sub>, V<sub>LD</sub> (V)" },
  "axis.vSwitch": { ko: "스위칭 전압 V<sub>LU</sub>, V<sub>LD</sub> (V)", en: "Switching voltage V<sub>LU</sub>, V<sub>LD</sub> (V)" },
  ...
  "axis.dmap.expected_trap_count": { ko: "기대 trap 수 ⟨N⟩", en: "Expected trap count ⟨N⟩" },
  ...
  "axis.s.S": { ko: "S", en: "S" },
  "axis.s.vluMean": { ko: "⟨V<sub>LU</sub>⟩ (V)", en: "⟨V<sub>LU</sub>⟩ (V)" },
  ...
  "axis.leg.modelUp": { ko: "모델 상향 스윕", en: "Model, up sweep" },
  "axis.leg.modelDown": { ko: "모델 하향 스윕", en: "Model, down sweep" },
  ...
  "axis.leg.h": { ko: "hazard h(V<sub>D</sub>)", en: "Hazard h(V<sub>D</sub>)" },
  ...
  "axis.leg.beyond": { ko: "{v} V 스윕 밖", en: "Beyond the {v} V sweep" },
  ...
  "axis.leg.run0": { ko: "과도 궤적 (run 0)", en: "Transient trajectory (run 0)" },
  ...
  "axis.ann.branch": { ko: "{b} branch", en: "{b} branch" },
  "axis.ann.full": { ko: "전체 궤적 (모든 branch)", en: "Full locus (all branches)" },
  "axis.cb.roots": { ko: "근 {n}개", en: "{n} roots" },
